...
export class ApiService {
    ...
    public async getApis(searchQuery?: SearchQuery): Promise<Page<Api>> {
        ...
        const pageOfApis = await this.backendClient.get<Page<ApiContract>>(query, [BackendClient.getPortalHeader("getApis")]);
    ...
    public async getApisInVersionSet(versionSetId: string): Promise<Api[]> {
        ...
        const apisPage = await this.backendClient.get<Page<ApiContract>>(query, [BackendClient.getPortalHeader("getApisInVersionSet")]);
    ...
    public async getOperationsByTags(apiId: string, searchQuery?: SearchQuery): Promise<Page<TagGroup<Operation>>> {
        ...
        const pageOfOperationsByTag = await this.backendClient.get<PageContract<ApiTagResourceContract>>(query, [BackendClient.getPortalHeader("getOperationsByTags")]);
    ...
    public async getApisByTags(searchRequest?: SearchQuery): Promise<Page<TagGroup<Api>>> {
        ...
        const pageOfApiTagResources = await this.backendClient.get<PageContract<ApiTagResourceContract>>(query, [BackendClient.getPortalHeader("getApisByTags")]);
    ...
    public async getOperationTags(operationId: string): Promise<Tag[]> {
        ...
        const result = await this.backendClient.get<Page<TagContract>>(`${operationId}/tags`, [BackendClient.getPortalHeader("getOperationTags")]);
    ...
    public async getApi(apiId: string, revision?: string): Promise<Api> {
        ...
        const apiContract = await this.backendClient.get<ApiContract>(apiResourceUri, [BackendClient.getPortalHeader("getApi")]);
    ...
    public exportApi(apiId: string, format: string): Promise<any> {
        ...
        const headers: HttpHeader[] = [BackendClient.getPortalHeader("exportApi")];
        headers.push(header);
        return this.backendClient.get<string>(apiId, headers);
    }
    ...
    public async getApiChangeLog(apiId: string, skip: number): Promise<Page<ChangeLogContract>> {
        ...
        const changelogContracts = await this.backendClient.get<Page<ChangeLogContract>>(apiResourceUri, [BackendClient.getPortalHeader("getApiChangeLog")]);
    ...
    public async getApiVersionSet(versionSetId: string): Promise<VersionSet> {
        const versionSetContract = await this.backendClient.get<VersionSetContract>(versionSetId, [BackendClient.getPortalHeader("getApiVersionSet")]);
    ...
    public async getOperation(operationId: string): Promise<Operation> {
        ...
        const operationContract = await this.backendClient.get<OperationContract>(operationId, [BackendClient.getPortalHeader("getOperation")]);
    ...
    public async getOperations(apiId: string, searchQuery?: SearchQuery): Promise<Page<Operation>> {
        ...
        const result = await this.backendClient.get<Page<OperationContract>>(query, [BackendClient.getPortalHeader("getOperations")]);
    ...
    public async getApiSchema(schemaId: string): Promise<Schema> {
        const contract = await this.backendClient.get<SchemaContract>(schemaId, [BackendClient.getPortalHeader("getApiSchema")]);
        const model = new Schema(contract);
        return model;
    }

    public async getSchemas(api: Api): Promise<Page<Schema>> {
        const result = await this.backendClient.get<Page<SchemaContract>>(`${api.id}/schemas`, [BackendClient.getPortalHeader("getSchemas")]);
        ...
        // return schemas;
        // const result = await this.backendClient.get<Page<SchemaContract>>(`${api.id}/schemas?$top=20`, null);
    ...
    public async getAllApiProducts(apiId: string): Promise<Page<Product>> {
        ...
        const result = [];
        const pageOfProducts = await this.backendClient.get<Page<ProductContract>>(`${apiId}/products`, [BackendClient.getPortalHeader("getAllApiProducts")]);
    ...
    public async getApiProductsPage(apiName: string, filter: SearchQuery): Promise<Page<Product>> {
        ...
        const page = await this.backendClient.get<Page<ProductContract>>(query, [BackendClient.getPortalHeader("getApiProductsPage")]);
    ...
    public async getProductApis(productId: string, searchQuery: SearchQuery): Promise<Page<Api>> {
        ...
        const result = await this.backendClient.get<Page<ApiContract>>(query, [BackendClient.getPortalHeader("getProductApis")]);
        const page = new Page<Api>();
    ...
    public async getApiHostnames(apiName: string): Promise<string[]> {
        ...
        const pageOfHostnames = await this.backendClient.get<Page<Hostname>>(query, [BackendClient.getPortalHeader("getApiHostnames")]);
